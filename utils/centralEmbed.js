    ...
    async createCentralEmbed(channelId, guildId) {
        try {
            ...
            const embed = new EmbedBuilder()
                .setAuthor({ name: 'Zyra Music Control Center', iconURL: 'https://cdn.discordapp.com/emojis/1449408483488436425.png', url: 'https://discord.gg/KWZMV7fZ' })
                .setDescription([
                    '',
                ...
                .setFooter({
                    text: 'Zyra Music Bot • Developed By Cyres ',
            ...
            if (trackInfo) {
                ...
                embed = new EmbedBuilder()
                    .setAuthor({
                        ...
                        iconURL: 'https://cdn.discordapp.com/emojis/1449405384778580039.gif',
                        url: 'https://discord.gg/KWZMV7fZ'
                    })
                    .setDescription([
                    ...
                    .setColor(embedColor)
                    .setFooter({
                        text: `Zyra Music Bot • ${statusText} • Developed By Cyres`,
                        iconURL: this.client.user.displayAvatarURL()
                    })
                    .setTimestamp();
                ...
                embed = new EmbedBuilder()
                    .setAuthor({ name: 'Zyra Music Control Center', iconURL: 'https://cdn.discordapp.com/emojis/1449405384778580039.gif', url: 'https://discord.gg/xQF9f9yUEM' })
                    .setDescription([
                        '',
                        '- Simply type a **song name** or **YouTube link** to start the party!',
                        '- In free version I only support **YouTube** only.',
